/**
 * ApiClient.ts — adaptadores de persistencia (TDD §4.2, §4.3, Fase 5).
 *
 * Sigue Ports & Adapters (Hexagonal Architecture):
 * - `ApiClient` es la interfaz del puerto.
 * - `LocalApiClient` es el adaptador para localStorage.
 * - `HttpApiClient` es el adaptador para la API REST conectada a PostgreSQL.
 */
